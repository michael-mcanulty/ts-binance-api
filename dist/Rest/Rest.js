...
const NewCancelOrder_1 = require("../Transaction/NewCancelOrder");
...
const NewOpenOrder_1 = require("../Transaction/NewOpenOrder");
...
class Rest extends BotHttp_1.BotHttp {
	...
	cancelOrder(symbol, orderId) {
		return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
			try {
				let cancelOrder = new NewCancelOrder_1.NewCancelOrder(symbol, orderId);
	...
	cancelOrdersBySymbol(symbol) {
		return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
			try {
				let cancelOrder = new NewCancelOrder_1.NewCancelOrder(symbol);
				if (cancelOrder && cancelOrder.hasOwnProperty("symbol")) {
	...
	getOpenOrders(symbol, orderId, recvWindow, origClientOrderId) {
		return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
			try {
				...
				let nOpen = new NewOpenOrder_1.NewOpenOrder(symbol, orderId, recvWindow, origClientOrderId);
				let privateOpenOrder = yield this.privateCall(url, callOpts, nOpen);
			}
			catch (err) {
				reject(err);
			}
