...
class BWebsocket extends Rest_1.Rest {
	constructor(options) {
		super(options);
		this._reconOptions = {};
	...
	static heartbeat() {
		setInterval(() => __awaiter(this, void 0, void 0, function* () {
			try {
				this.isAlive = yield BWebsocket.Instance.ping();
			}
			catch (err) {
	...
	openWebSocket(url) {
		if (url) {
			this.url = url;
			BWebsocket._ws = new ReconnectingWebSocket_1.default(this.url, undefined, this._reconOptions);
